...
def lighten_helper (pixel):
    if pixel[0] <= 245:
       red_intensity =  pixel[0]+10
    else:
        red_intensity = 255
    if pixel[1] <= 245:
        green_intensity = pixel[1] + 10
    else:
        green_intensity = 255
    if pixel[2] <= 245:
        blue_intensity = pixel[2] + 10
    else:
        blue_intensity = 255
...
def lighten(image_surf):
    ...
    for x in range(rows):
        for y in range(cols):
            pixels3d[x,y] = lighten_helper(pixels3d[x,y])

def darken_helper (pixel):
    if pixel[0] >= 10:
       red_intensity =  pixel[0]-10
    else:
        red_intensity = 0
...
def darken(image_surf):
    ...
    for x in range(rows):
        for y in range(cols):
            pixels3d[x,y] = darken_helper(pixels3d[x,y])
